...
import SearchCustomers from "@/components/staff/SearchCustomers"
import SearchProducts from "@/components/staff/SearchProducts"
...
const Staff = () => {
	...
	const saveBill = async () => {
		...
		try {
			const { data } = await staffApi.post("/bill", {
				staff: staff._id,
				shop: staff.shop,
